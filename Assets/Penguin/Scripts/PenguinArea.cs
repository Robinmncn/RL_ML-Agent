...
public class PenguinArea : MonoBehaviour
{
    ...
    /// <summary>
    /// Reset the Area, initialize the agent and gameObject positions
    /// </summary>
    ...
    /// <summary>
    /// Remove a specific fish once it is eaten
    /// </summary>
    /// <param name="fishObject"> the fish we want to remove </param>
    ...
    /// <summary>
    /// Chose a random position within a partial donut shape
    /// </summary>
    /// <param name="center"> The center of the donut </param>
    /// <param name="minAngle"> Minimum angle of the wedhe </param>
    ...
    /// <summary>
    /// Spawn a given number of fish in the area at a given speed
    /// </summary>
    /// <param name="count"> number of fish wanted </param>
