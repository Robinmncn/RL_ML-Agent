...
public class PenguinAgent : Agent
{
    ...
    /// <summary>
    /// Initial setup, called once when the agent is enabled
    /// </summary>
    ...
    /// <summary>
    /// Where the agent receive and respond to the actions
    /// </summary>
    ...
    /// </summary>
    /// 
    /// TODO : Update with ML-Agent to add some memory : https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Training-PPO.md#optional-recurrent-neural-network-hyperparameters
    /// 
    ...
    private void FixedUpdate()
    {
        ...
        // of the previous decision, it helps us saving processing and reduce jitter
        if (GetStepCount() % 5 == 0)
        {
            RequestDecision();
        }
